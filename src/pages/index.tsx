...
export default function Home() {
  ...
  return (
    <>
      ...
      <Stack justify="center" align="center" w="100vw" h="100vh" gap={0}>
        <Stack align="center" gap={0}>
          <Group w="96vw" h="10vh" justify="space-between" align="center">
            <Title order={3}>ZK Simple Multiplier</Title>
            <ConnectWalletButton />
          </Group>
          <Grid align="center" justify="center" mih="80vh">
            <Grid.Col span={{ sm: 8, md: 6, lg: 4 }}>
              <Text>
                {
          ...
          <Group w="96vw" h="10vh" justify="center" align="center">
