...
contract PlonkVerifier {
    ...
    uint256 constant Qmx =
        13842400266396140247675648350434661472294581990887415299458004374641921640629;
    uint256 constant Qmy =
        19981703439343209570787739271716146520556189342411532113083814130524287115314;
    uint256 constant Qlx =
        18546979979186815922470245332102014253185318350853780370996681779105164088715;
    uint256 constant Qly =
        378896680264496194086981753158623438450743981717384879191540240140877595925;
    uint256 constant Qrx =
        5527373491794550204585778704160434946172332945822911103712492818434918865869;
    uint256 constant Qry =
        9475467641775117083999132509594032741917913247454859578696216316799206284694;
    uint256 constant Qox =
        12559739742699494686855307844306518409947951684197544476902238756742135623536;
    uint256 constant Qoy =
        18171981811234820661015275860631167936887983612668144631367337649972092780948;
    uint256 constant Qcx =
        8109683207665220921801529333071089567885230905656119568429218137915178842004;
    uint256 constant Qcy =
        2758632476335119222706619604872263567768209592714865290703521176074328743307;
    uint256 constant S1x =
        4088688336978357627903277782123187940711296749315391687557819277581131662674;
    uint256 constant S1y =
        12055283242361374856590264839964744583752461077883656146475883697922660574374;
    uint256 constant S2x =
        18085109636977482932259852903887849820647957341493444548666461789967790652549;
    uint256 constant S2y =
        11067407930200425515705964525170669145920433771590112025685398084373993097632;
    uint256 constant S3x =
        11195162923725043710330892728528866923071244511886500783239347210867275916291;
    uint256 constant S3y =
        14238268292578190305890145778157096267647773920232953884951785565252849384517;
